...
namespace BizKidzScholarships.Data.Migrations
{
    ...
    [Migration("20260228042408_Child-Name")]
    partial class ChildName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BizKidzScholarships.Data.Entities.QuizOption", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OptionId = 1,
                            Created = new DateTimeOffset(new DateTime(2026, 2, 20, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            OptionKey = "A",
            ...
            modelBuilder.Entity("BizKidzScholarships.Data.Entities.SiteDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTimeOffset(new DateTime(2026, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("BizKidzScholarships.Data.Entities.TaskItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTimeOffset(new DateTime(2026, 2, 28, 4, 24, 8, 449, DateTimeKind.Unspecified).AddTicks(8256), new TimeSpan(0, 0, 0, 0, 0)),
                            IsGlobalTask = true,
                            Reward = 50,
                            ...
                            TaskType = 1,
                            Updated = new DateTimeOffset(new DateTime(2026, 2, 28, 4, 24, 8, 449, DateTimeKind.Unspecified).AddTicks(8265), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTimeOffset(new DateTime(2026, 2, 28, 4, 24, 8, 449, DateTimeKind.Unspecified).AddTicks(8268), new TimeSpan(0, 0, 0, 0, 0)),
                            IsGlobalTask = true,
                            Reward = 50,
                            ...
                            TaskType = 2,
                            Updated = new DateTimeOffset(new DateTime(2026, 2, 28, 4, 24, 8, 449, DateTimeKind.Unspecified).AddTicks(8268), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTimeOffset(new DateTime(2026, 2, 28, 4, 24, 8, 449, DateTimeKind.Unspecified).AddTicks(8271), new TimeSpan(0, 0, 0, 0, 0)),
                            IsGlobalTask = true,
                            Reward = 50,
                            ...
                            TaskType = 3,
                            Updated = new DateTimeOffset(new DateTime(2026, 2, 28, 4, 24, 8, 449, DateTimeKind.Unspecified).AddTicks(8271), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 4,
                            Created = new DateTimeOffset(new DateTime(2026, 2, 28, 4, 24, 8, 449, DateTimeKind.Unspecified).AddTicks(8273), new TimeSpan(0, 0, 0, 0, 0)),
                            IsGlobalTask = true,
                            Reward = 0,
                            ...
                            TaskType = 3,
                            Updated = new DateTimeOffset(new DateTime(2026, 2, 28, 4, 24, 8, 449, DateTimeKind.Unspecified).AddTicks(8274), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("BizKidzScholarships.Data.Entities.UserConsent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTimeOffset>("ConsentTimeUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("BizKidzScholarships.Data.Entities.UserConsent", b =>
                {
                    b.HasOne("BizKidzScholarships.Data.Entities.SiteDocument", "Document")
                        .WithMany()
