...
The application is a task-based, full-stack app with an admin-accessible interface. There is a logically separated front-end (React) and Backend (ASP.NET Core Web API / Entity Framework Core / PostgreSQL).
